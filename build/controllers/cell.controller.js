...
var CellService = _interopRequireWildcard(require("../services/cell.service"));
...
var getAllCells = /*#__PURE__*/function () {
  ...
  return function getAllCells(_x, _x2, _x3) {
...
var getCell = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return CellService.getCell(req.params._id);
  ...
  return function getCell(_x4, _x5, _x6) {
...
var newCell = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return CellService.newCell(req.body);
  ...
  return function newCell(_x7, _x8, _x9) {
...
var updateCell = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return CellService.updateCell(req.params._id, req.body);
  ...
  return function updateCell(_x10, _x11, _x12) {
...
var deleteCell = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return CellService.deleteCell(req.params._id);
  ...
  return function deleteCell(_x13, _x14, _x15) {
