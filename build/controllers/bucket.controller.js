...
exports.updateBucket = exports.newBucket = exports.getBucket = exports.getAllBuckets = exports.deleteBucket = void 0;
...
var BucketService = _interopRequireWildcard(require("../services/bucket.service"));
...
var getAllBuckets = /*#__PURE__*/function () {
  ...
  return function getAllBuckets(_x, _x2, _x3) {
...
var getBucket = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return BucketService.getBucket(req.params._id);
  ...
  return function getBucket(_x4, _x5, _x6) {
...
var newBucket = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return BucketService.newBucket(req.body);
  ...
  return function newBucket(_x7, _x8, _x9) {
...
var updateBucket = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return BucketService.updateBucket(req.params._id, req.body);
  ...
  return function updateBucket(_x10, _x11, _x12) {
...
var deleteBucket = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return BucketService.deleteBucket(req.params._id);
  ...
  return function deleteBucket(_x13, _x14, _x15) {
