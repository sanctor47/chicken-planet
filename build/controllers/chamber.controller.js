...
exports.updateChamber = exports.newChamber = exports.getChamber = exports.getAllChambers = exports.deleteChamber = void 0;
...
var ChamberService = _interopRequireWildcard(require("../services/chamber.service"));
...
var getAllChambers = /*#__PURE__*/function () {
  ...
  return function getAllChambers(_x, _x2, _x3) {
...
var getChamber = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return ChamberService.getChamber(req.params._id);
  ...
  return function getChamber(_x4, _x5, _x6) {
...
var newChamber = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return ChamberService.newChamber(req.body, res.locals._id, res.locals.domain);
  ...
  return function newChamber(_x7, _x8, _x9) {
...
var updateChamber = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return ChamberService.updateChamber(req.params._id, req.body);
  ...
  return function updateChamber(_x10, _x11, _x12) {
...
var deleteChamber = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return ChamberService.deleteChamber(req.params._id);
  ...
  return function deleteChamber(_x13, _x14, _x15) {
